...
//+kubebuilder:webhook:path=/mutate-cache-example-com-v1alpha1-runner,mutating=true,failurePolicy=fail,sideEffects=None,groups=cache.example.com,resources=runners,verbs=create;update,versions=v1alpha1,name=mrunner.kb.io,admissionReviewVersions={v1,v1beta1}

var _ webhook.Defaulter = &Runner{}

// Default implements webhook.Defaulter so a webhook will be registered for the type
func (r *Runner) Default() {
	runnerlog.Info("default", "name", r.Name)
